...
{\noindent \bfseries \zihao{-5} Keywords：}multimodal person re-identification; cross-modal matching; feature alignment; attention mechanism; unsupervised learning; video multimodal fusion
...
{\noindent \zihao{5} 3.1\quad 特征对齐与多维度跨模态融合}\par
...
{\noindent \zihao{5} 3.2\quad 多样化注意力机制与特征增强}\par
...
{\noindent \zihao{5} 3.3\quad 语义增强与无监督 / 半监督学习}\par
...
{\noindent \zihao{5} 3.4\quad 视频跨模态融合与时空信息协同}\par
...
{\noindent \zihao{5} 3.5\quad 模态差异消除与特征分布对齐}\par
