...
block1 = torch.nn.Sequential(*resnet_block(64, 64, 2, first_block=True))
block2 = torch.nn.Sequential(*resnet_block(64, 128, 2))
block3 = torch.nn.Sequential(*resnet_block(128, 256, 2))
block4 = torch.nn.Sequential(*resnet_block(256, 512, 2))
