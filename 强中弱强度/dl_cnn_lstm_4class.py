...
def plot_confusion_matrix(y_true, y_pred, save_path):
    ...
    ax.set_title('混淆矩阵 (CNN-LSTM)', fontsize=16, pad=20)
...
def main():
    ...
    print('\n7. 保存图表...')
    plot_training_curves(train_losses, train_accs, test_accs, 'img/training_curves_cnn_lstm.png')
    plot_confusion_matrix(y_true, y_pred, 'img/confusion_matrix_cnn_lstm.png')
